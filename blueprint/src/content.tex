...
\begin{theorem}[Final bound inside a clique]
  ...
  \lean{finale_bound}
  \uses{lem:Better_forms_clique, lem:Better_non_decr, def:UniformBetter, lem:UniformBetter_edges_value, lem:bound_real, lem:computation, lem:clique_size, lem:UniformBetter_edges_value}
  \leanok
