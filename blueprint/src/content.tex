...
\begin{lemma}[Uniform weights on the support]
  ...
  \uses{lem:UniformBetter, def:Enhanced, lem:UniformBetter_support_equiv, lem:Enhanced_inc_uniform_count, thm:Enhance_total_weight_stricinc}
  \leanok
